...
function MadePresentationSection() {
  return (
    <section className={styles.twoColumnSection}>
      <div className={styles.content}>
        <h1 className="title">C&apos;est quoi Made ?</h1>
        <p>
          Trouve des idées diverses de projet, obtient les maquettes et la correction puis présente tous ça à tes futurs
          clients.
        </p>
  ...
  return (
    <section className={`${styles.twoColumnSection} ${styles.gridReverse}`}>
      <div className={styles.content}>
        ...
        <p>Crée ton profil afin de poster tes projets et pouvoir être vu et contacté par d&apos;autres utilisateurs.</p>
        <div className={`${styles.buttonWrapper} mx-auto lg:mx-0 mb-8 lg:mb-0`}>
  ...
  return (
    <section className={styles.twoColumnSection}>
      <div className={styles.content}>
        ...
        <p>
          Tu as besoin d&apos;aide pour réaliser des actions sur Made, des bus sont survenus subitements et tu aimerais
          nous en faire part ?
        </p>
    ...
    <section>
      ...
      <div className={styles.twoColumnSection}>
        ...
        <div className={`${styles.content} centered mt-16 lg:mt-0`}>
          <div>
            <Image src="/img/design/drawings/apprentissage.svg" alt="Cible avec fléchette" width={138} height={142} />
          </div>
